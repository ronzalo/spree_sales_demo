...
ActiveRecord::Schema.define(version: 20150114150833) do
  ...
  add_index "spree_addresses", ["county_id"], name: "index_spree_addresses_on_county_id"
  ...
  create_table "spree_counties", force: true do |t|
    t.string   "name"
    t.integer  "state_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "spree_counties", ["state_id"], name: "index_spree_counties_on_state_id"
  ...
  create_table "spree_voucher_events", force: true do |t|
  ...
  add_index "spree_voucher_events", ["voucher_id"], name: "index_spree_voucher_events_on_voucher_id"

  create_table "spree_vouchers", force: true do |t|
    t.string  "number",                                                      null: false
    t.date    "expiration"
    t.decimal "original_amount",   precision: 8, scale: 2, default: 0.0,     null: false
  ...
  add_index "spree_vouchers", ["expiration"], name: "index_spree_vouchers_on_expiration"
  add_index "spree_vouchers", ["line_item_id"], name: "index_spree_vouchers_on_line_item_id"
